...
# Load Excel file from Desktop 'dashboard' folder
file_path = os.path.expanduser("~/Desktop/dashboard/root_data.xlsx")
...
try:
    ...
    st.error(f"Failed to load data from ~/Desktop/dashboard/root_data.xlsx: {e}").